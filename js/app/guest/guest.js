	...
	export const guest = (() => {
	    ...
	    const buildGoogleCalendar = () => {
	        ...
	        const data = new URLSearchParams({
	            action: 'TEMPLATE',
	            text: 'The Wedding of Juliansyah and Ejah',
	            dates: `${formatDate('2025-06-30 10:00')}/${formatDate('2025-06-30 14:00')}`,
	            details: 'Tanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara pernikahan kami. Terima kasih atas perhatian dan doa restu Anda, yang menjadi kebahagiaan serta kehormatan besar bagi kami.',
	            location: 'Kp.Situdukun RT01/01, Kel.Taman Jaya,Kec.Taman Sari, Kota Tasikmalaya, Jl. Tamansari Gobras No.48, Mulyasari, Kec. Tamansari, Kab. Tasikmalaya, Jawa Barat 46196.',
	            ctz: config.get('tz'),
	        });
